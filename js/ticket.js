try {
  ...
  totalesEl.innerHTML = `
    ...
    <div>Impuesto: $${ticket.exportFee.toLocaleString()}</div>
  ...
  document.body.innerHTML = `
    <div style="padding:40px;color:#fff;">
      No hay comprobante para mostrar. <a href="principal.html">Volver</a>
    </div>`;
} finally {
